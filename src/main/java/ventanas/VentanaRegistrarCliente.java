...
public class VentanaRegistrarCliente extends Ventana {
    ...
    private boolean registrarCliente(){
        return automotora.agregarCliente(this.campoNombre.getText(),this.campoDireccion.getText(),this.campoCorreo.getText(),
                this.campoRut.getText(), this.campoNumeroTelefonico.getText());
    }
